        ...
        <div className="weather-app">
          <div className="weather-bar">
            ...
            <div className="weater-bar-box">
              ...
              <img className="weather-img" src={weater_1.img} alt="weater Image"/>
            ...
            <div className="weater-bar-box">
              ...
              <img className="weather-img" src={weater_2.img} alt="weater Image"/>
              <div className="temp-align">
            ...
            <div className="weater-bar-box">
              ...
              <img className="weather-img" src={weater_3.img} alt="weater Image"/>
              <div className="temp-align">
            ...
            <div className="weater-bar-box">
              ...
              <img className="weather-img" src={weater_4.img} alt="weater Image"/>
              <div className="temp-align">
            ...
            <div className="weater-bar-box">
              ...
              <img className="weather-img" src={weater_5.img} alt="weater Image"/>
              <div className="temp-align">
            ...
            <div className="weater-bar-box">
              ...
              <img className="weather-img" src={weater_6.img} alt="weater Image"/>
              <div className="temp-align">
            ...
            <div className="weater-bar-box">
              ...
              <img className="weather-img" src={weater_7.img} alt="weater Image"/>
              <div className="temp-align">
